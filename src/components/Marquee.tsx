...
export function Marquee() {
  return (
    ...
    >
      {/* Accent corner marks */}
      <div className="absolute top-2 left-4 text-[0.6rem] tracking-[0.2em] uppercase" style={{ color: "var(--accent)", fontFamily: "var(--font-mono), monospace", opacity: 0.5 }}>
        ◈ SYS://PORTFOLIO
      </div>
      <div className="absolute top-2 right-4 text-[0.6rem] tracking-[0.2em] uppercase" style={{ color: "var(--retro)", fontFamily: "var(--font-mono), monospace", opacity: 0.5 }}>
        NODE_ACTIVE ◈
      </div>
